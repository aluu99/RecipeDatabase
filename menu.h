...
private:
    ...
    const vector<string> find_recipe        = { "By Name", 
                                                "By Time", 
                                                "By Ingredient", 
                                                "By Meal Type",     
                                                "By Diet"  };

    const vector<string> find_by_name       = { "By Exact Name", 
                                                "By Keyword" };

    const vector<string> find_by_time       = { "By Exact Time", 
                                                "By Time Range" };

    const vector<string> find_by_ingred     = { "By Exact Ingredient", 
                                                "By Keyword" };

    const vector<string> find_by_meal       = { "Breakfast", 
                                                "Lunch", 
                                                "Dinner", 
                                                "Snack", 
                                                "Drink", 
